...
class AchatResource extends Resource
{
    ...
    {
        return static::getModel()::count(); // Always show total count
    }
    
    public static function getNavigationBadgeColor(): ?string
    {
        return 'primary'; // Normal badge stays primary color
    }
    
    public static function getNavigationBadgeAttributes(): array
    {
        ...
        if ($trashedCount > 0) {
            return [
                [
                    'color' => 'danger', // Red badge for soft deleted count
                    'value' => (string) $trashedCount, 
                ],
            ];
        }
