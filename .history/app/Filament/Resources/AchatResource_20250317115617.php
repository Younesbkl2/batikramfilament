    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->actions([
                ...
                ->modalHeading('View Achat')
                ->modalDescription('Details of the selected record.')
                ->slideOver() // Optional: Opens as a slide-over instead of a modal
                ->modalWidth('2xl'), // Adjust width if needed
            ...
            ->recordUrl(null), // Disables default click behavior
            ->rowAction(fn ($record) => Tables\Actions\ViewAction::make()->record($record)); // Opens view modal
