...
class AchatResource extends Resource
{
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                Tables\Columns\TextColumn::make('codachat')->sortable()->searchable(isIndividual: true),
                Tables\Columns\TextColumn::make('codeclient')->sortable()->searchable(isIndividual: true),
