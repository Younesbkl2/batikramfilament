...
class AchatResource extends Resource
{
    ...
    {
        return null; // Prevents Filament from opening the edit page
    }
    
    public static function getGlobalSearchResultAction(\Illuminate\Database\Eloquent\Model $record): ?array
    {
        return [
            'type' => 'openModal',
