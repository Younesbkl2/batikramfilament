        ...
        return $table
            ...
            ->filters([
                ...
                Tables\Filters\SelectFilter::make('superficie')
                    ...
                    ->searchable()
                    ->preload()
                    ->options(fn () => Appartement::whereNotNull('blocappartement')->orderBy('superficie')->pluck('superficie', 'superficie')->toArray()),                                    
                Tables\Filters\SelectFilter::make('etage')
                    ->label('Etage')
                    ->searchable()
                    ->preload()
                    ->options(fn () => Appartement::whereNotNull('blocappartement')->pluck('etage', 'etage')->toArray()),            
