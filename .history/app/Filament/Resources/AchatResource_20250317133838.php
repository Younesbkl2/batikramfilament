...
class AchatResource extends Resource
{
    ...
    public static function getGlobalSearchResultUrl(array $record): ?string
    {
        return null; // Disable the default edit page redirection
    }

    public static function getGlobalSearchResultAction(array $record): ?array
    {
        return [
            'type' => 'openModal',
            'modal' => 'filament.resources.view-record',
            'record' => $record['id'],
        ];
    }
    ...
    {
        return parent::getEloquentQuery()->withTrashed()->with(['client']);
    }     
}
