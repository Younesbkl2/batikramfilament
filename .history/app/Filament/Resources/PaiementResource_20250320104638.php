    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->filters([
                ...
                Filter::make('datepaie')
                    ->form([
                        DatePicker::make('created_from')->label('A partir de')->native(false)->suffixIcon('heroicon-o-calendar')->displayFormat('d/m/Y'),
                        DatePicker::make('created_until')->label('Jusqu à')->native(false)->suffixIcon('heroicon-o-calendar')->displayFormat('d/m/Y'),
                    ])
