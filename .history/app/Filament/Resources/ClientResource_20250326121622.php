...
class ClientResource extends Resource
{
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->headerActions([
                ExportAction::make()->label('Exporter tous les Clients')->exporter(ClientExporter::class),
            ])
            ->bulkActions([
                ...
                ExportBulkAction::make()->label('Exporter les Clients sélectionnés')->exporter(ClientExporter::class)
            ]);
    }
