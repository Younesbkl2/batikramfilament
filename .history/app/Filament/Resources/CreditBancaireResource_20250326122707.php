...
class CreditBancaireResource extends Resource
{
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->headerActions([
                ExportAction::make()->label('Exporter tous les CreditBancaires')->exporter(CreditBancaireExporter::class),
            ])
            ->bulkActions([
                ...
                ExportBulkAction::make()->label('Exporter les CreditBancaires sélectionnés')->exporter(CreditBancaireExporter::class)
            ]);
    }
