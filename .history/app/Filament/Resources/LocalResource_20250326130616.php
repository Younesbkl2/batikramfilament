...
use App\Filament\Exports\LocalExporter;
        ...
        return $table
            ...
            ->filters([
                ...
                Tables\Filters\SelectFilter::make('codeprod')
                    ...
                    ->getOptionLabelFromRecordUsing(fn ($record) => "{$record->codeprod} ({$record->Typeproduit})")
                    ->preload(),
                Tables\Filters\SelectFilter::make('surfacelocal')
                    ->label('Surface')
                    ->searchable()
                    ->preload()
                    ->options(fn () => Local::whereNotNull('surfacelocal')->orderBy('surfacelocal')->pluck('surfacelocal', 'surfacelocal')->toArray()),                    
            ...
            ->headerActions([
                ExportAction::make()->label('Exporter tous les Locals')->exporter(LocalExporter::class),
            ])
            ->bulkActions([
                ...
                ExportBulkAction::make()->label('Exporter les Locals sélectionnés')->exporter(LocalExporter::class)
            ]);
    }
