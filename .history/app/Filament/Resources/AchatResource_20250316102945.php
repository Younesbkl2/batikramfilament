...
class AchatResource extends Resource
{
    ...
    {
        return static::getModel()::count(); // Always show the total count
    }
    
    public static function getNavigationBadgeColor(): ?string
    {
        return 'primary'; // Keeps the main badge color always the same
    }
    
    public static function getCustomNavigationBadges(): array
    {
        ...
        if ($trashedCount > 0) {
            return [
                [
                    'color' => 'danger', // Red badge for soft deletes
                    'value' => (string) $trashedCount, // Shows soft-deleted count
                ],
            ];
        }
