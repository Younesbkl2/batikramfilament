...
class ClientResource extends Resource
{
        ...
        return $table
            ...
            ->actions([
                Tables\Actions\EditAction::make()
                    ->visible(fn ($record) => ! $record->trashed()), // Ensure Filament correctly recognizes trashed records
    ...
    {
        return parent::query($query)->withoutGlobalScopes([SoftDeletingScope::class]);
    }
