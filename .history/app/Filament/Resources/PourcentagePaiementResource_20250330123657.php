...
class PourcentagePaiementResource extends Resource
{
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->headerActions([
                ExportAction::make()->label('Exporter tous les rapports')->exporter(PourcentagePaiementExporter::class),
            ])
            ->bulkActions([
                ExportBulkAction::make()->label('Exporter les rapports sélectionnés')->exporter(PourcentagePaiementExporter::class)
            ]);
    }
