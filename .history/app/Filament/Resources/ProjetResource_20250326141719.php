...
use App\Filament\Exports\ProjetExporter;
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->filters([
                ...
                ->searchable()
                ->preload()
                ->options(fn () => Projet::whereNotNull('Libelleprj')->pluck('Libelleprj', 'Libelleprj')->toArray()),
            ...
            ->headerActions([
                ExportAction::make()->label('Exporter tous les Projets')->exporter(ProjetExporter::class),
            ])
            ->bulkActions([
                ...
                ExportBulkAction::make()->label('Exporter les Projets sélectionnés')->exporter(ProjetExporter::class)
            ]);
    }
