...
class AchatResource extends Resource
{
    ...
    {
        $totalCount = static::getModel()::count(); // Total records
        $trashedCount = static::getModel()::onlyTrashed()->count(); // Soft-deleted records
    
        if ($trashedCount > 0) {
            return "{$totalCount} / {$trashedCount}"; // Example: "10 / 3"
        }
    ...
    public static function getNavigationBadgeColor(): ?string
    {
        ...
        return $trashedCount > 0 ? 'danger' : 'primary'; 
    }
