    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('Champ1')->searchable(),
                Tables\Columns\TextColumn::make('Champ2')->searchable(),
                Tables\Columns\TextColumn::make('Champ3')->searchable(),
                Tables\Columns\TextColumn::make('Champ4')->searchable(),
                Tables\Columns\TextColumn::make('Champ5')->searchable(),
                Tables\Columns\TextColumn::make('Champ6')->searchable(),
                Tables\Columns\TextColumn::make('Champ7')->searchable(),
