...
use App\Filament\Exports\PaiementExporter;
...
class PaiementResource extends Resource
{
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                ->summarize([
                    Tables\Columns\Summarizers\Sum::make()
                        ->money('DZD')
                        ->label('Total Page')
                        ->currentPageOnly(), // This limits the sum to current page
                ]),
            ...
            ->headerActions([
                ExportAction::make()->label('Exporter tous les Paiements')->exporter(PaiementExporter::class),
            ])
            ->bulkActions([
                ...
                ExportBulkAction::make()->label('Exporter les Paiements sélectionnés')->exporter(PaiementExporter::class)
            ]);
    }
