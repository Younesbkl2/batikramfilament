        ...
        return $form
            ->schema([
                ...
                Section::make('Property Details')
                    ->schema([
                        TextInput::make('numappartement')
                            ->label('Appartement')
                            ->disabled(),
                        TextInput::make('prix_appartement')
                            ->label('Appartement Price')
                            ->numeric()
                            ->disabled(),
                        TextInput::make('numparking')
                            ->label('Parking')
                            ->disabled(),
                        TextInput::make('prix_parking')
                            ->label('Parking Price')
                            ->numeric()
                            ->disabled(),
                        TextInput::make('Numlocal')
                            ->label('Local Number')
                            ->disabled(),
                        TextInput::make('prix_local')
                            ->label('Local Price')
                            ->numeric()
                            ->disabled(),
                    ])
                ...
                Section::make('Financial Summary')
                    ->schema([
                        TextInput::make('total_prix')
                            ->label('Total Price (A+P+L)')
                            ->numeric()
                            ->disabled(),
                        TextInput::make('total_depense')
                            ->label('Amount Paid')
                            ->numeric()
                            ->disabled(),
                ...
                Section::make('Project & Ownership')
                    ->schema([
                        TextInput::make('projet.Libelleprj')
                            ->label('Project')
                            ->disabled(),
                        TextInput::make('proprietaire.nom_proprietaire')
                            ->label('Owner')
                            ->disabled(),
                    ])
                    ->columns(2),
