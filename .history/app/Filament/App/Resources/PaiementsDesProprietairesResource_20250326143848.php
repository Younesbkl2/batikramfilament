...
use App\Filament\Exports\PaiementsDesProprietairesExporter;
...
class PaiementsDesProprietairesResource extends Resource
{
   ...
   public static function table(Table $table): Table
   {
       return $table
           ...
           ->headerActions([
            ExportAction::make()->label('Exporter tous les Paiements Des Proprietaires')->exporter(PaiementsDesProprietairesExporter::class),
        ])
           ->bulkActions([
            ExportBulkAction::make()->label('Exporter les Paiements Des Proprietaires sélectionnés')->exporter(PaiementsDesProprietairesExporter::class)
           ]);
   }
