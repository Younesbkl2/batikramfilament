...
use App\Filament\Exports\AchatExporter;
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                ...
                Forms\Components\TextInput::make('apport_personel')
                    ->label('Apport Personnel (DZD)')
                    ->numeric()
                    ->inputMode('decimal'),
                    
                Forms\Components\TextInput::make('credit_bancaire')
                    ->label('Crédit Bancaire (DZD)')
                    ->numeric()
                    ->inputMode('decimal'),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('apport_personel')
                    ->label('Apport Personnel')
                    ->money('DZD')
                    ->sortable()
                    ->toggleable(),
                    
                Tables\Columns\TextColumn::make('credit_bancaire')
            ...
            ->headerActions([
                ExportAction::make()->label('Exporter tous les Achats')->exporter(AchatExporter::class),
            ])
            ->bulkActions([
                ...
                ExportBulkAction::make()->label('Exporter les Achats sélectionnés')->exporter(AchatExporter::class)
            ]);
    }
