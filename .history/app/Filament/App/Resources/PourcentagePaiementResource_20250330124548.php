...
use App\Filament\Exports\PourcentagePaiementExporter;
use App\Filament\App\Resources\PourcentagePaiementResource\Pages;
use App\Filament\App\Resources\PourcentagePaiementResource\RelationManagers;
...
class PourcentagePaiementResource extends Resource
{
    ...
    public static function getGlobalSearchResultDetails(Model $record): array
    {
        ...
        if (!empty($record->percentage_apport_personel_paye)) {
            $details['% Apport Personel Payé'] = $record->percentage_apport_personel_paye . '%';
        }
        if (!empty($record->percentage_credit_bancaire_paye)) {
            $details['% Crédit Bancaire Payé'] = $record->percentage_credit_bancaire_paye . '%';
        }

        $details['% Total Payé'] = $record->percentage_total_paye . '%';
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->headerActions([
                ExportAction::make()->label('Exporter tous les Pourcentage Paiements')->exporter(PourcentagePaiementExporter::class),
            ])
            ->bulkActions([
                ExportBulkAction::make()->label('Exporter les Pourcentage Paiements sélectionnés')->exporter(PourcentagePaiementExporter::class)
            ]);
    }
