    ...
    protected function getTableBulkActions(): array
    {
        return [
            ExportBulkAction::make()
                ...
                ->button() // This makes it appear as a regular button
                ->color('primary') // Optional: adds color to make it stand out
                ->extraAttributes([
                    'style' => 'min-width: 250px; white-space: nowrap;' // Ensures full text shows
                ])
        ];
    }
