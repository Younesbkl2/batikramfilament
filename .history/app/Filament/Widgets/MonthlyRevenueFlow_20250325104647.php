...
class MonthlyRevenueFlow extends LineChartWidget
{
    ...
    protected function getFilters(): ?array
    {
        return [
            ...
            'modepaie' => Paiement::distinct()
                ...
                ->pluck('modepaie')
                ->mapWithKeys(fn ($mode) => [$mode => $mode]) // Ensures an associative array
                ->toArray(),
        ];
    }
    ...
    {
        $filters = $this->getFilters(); // Fetch once to avoid duplicate calls
        ...
        return [
            ...
            Forms\Components\Select::make('modepaie')
                ...
                ->options($filters['modepaie']) // Now correctly formatted
                ->nullable()
                ->reactive(),
        ];
    }
