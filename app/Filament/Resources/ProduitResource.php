...
class ProduitResource extends Resource
{
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->headerActions([
                ExportAction::make()->label('Exporter tous les Produits')->exporter(ProduitExporter::class),
            ])
            ->bulkActions([
                ...
                ExportBulkAction::make()->label('Exporter les Produits sélectionnés')->exporter(ProduitExporter::class)
            ]);
    }
