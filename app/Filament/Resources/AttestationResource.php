...
use App\Filament\Exports\AttestationExporter;
...
class AttestationResource extends Resource
{
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->headerActions([
                ExportAction::make()->label('Exporter tous les Attestations')->exporter(AttestationExporter::class),
            ])
            ->bulkActions([
                ...
                ExportBulkAction::make()->label('Exporter les Attestations sélectionnés')->exporter(AttestationExporter::class)
            ]);
    }
