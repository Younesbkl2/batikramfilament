...
use App\Filament\Exports\CreditBancaireExporter;
...
class CreditBancaireResource extends Resource
{
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->headerActions([
                ExportAction::make()->label('Exporter tous les Credit Bancaires')->exporter(CreditBancaireExporter::class),
            ])
            ->bulkActions([
                Tables\Actions\BulkActionGroup::make([
                    Tables\Actions\DeleteBulkAction::make(),
                ]),
                ExportBulkAction::make()->label('Exporter les Credit Bancaires sélectionnés')->exporter(CreditBancaireExporter::class)
            ]);
    }
