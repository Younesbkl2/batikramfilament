...
class CreditBancaire extends Model
{
    ...
    protected $table = 'creditbancaires';
    protected $primaryKey = 'id';
    public $incrementing = true;
    protected $keyType = 'int';

    protected $fillable = [
        'codeclient', 'codebanque', 'depotdossier', 'comite', 'paiementfrais', 'signatureconvenrg',
        'dossiertransfnotaire', 'signvspclientgerant', 'recuperationcheque',
        'enrgvsp', 'publicationvsp', 'paiementtranches'
    ];
    ...
    protected static function boot()
    {
        ...
        static::saving(function ($model) {
            foreach ([
                        'depotdossier', 'comite', 'paiementfrais', 'signatureconvenrg',
                        'dossiertransfnotaire', 'signvspclientgerant', 'recuperationcheque',
                        'enrgvsp', 'publicationvsp', 'paiementtranches'
                    ] as $feature) {
